...
export default class Message {
  ...
  constructor() {
    const containerId = `${classPrefix}-message-container`
  ...
  show({ text = '', duration = 3000 }: IShow): void {
    ...
    `
    this.containerEl && this.containerEl.appendChild(messageEl)
  ...
  close(messageEl: HTMLElement): void {
